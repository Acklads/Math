...
📈 描述性统计:")
    ...
    def correlation_analysis(self):
        ...
        plt.title(f'问题3 - 变量相关性热力图')
        plt.tight_layout()
        plt.savefig(f'../可视化结果/问题3_相关性分析.png', dpi=300, bbox_inches='tight')
        plt.show()
    ...
    def distribution_analysis(self):
        ...
        plt.suptitle(f'问题3 - 变量分布分析')
        plt.tight_layout()
        plt.savefig(f'../可视化结果/问题3_分布分析.png', dpi=300, bbox_inches='tight')
        plt.show()
    ...
    def outlier_detection(self):
        ...
        plt.title(f'问题3 - 异常值检测（箱线图）')
        plt.xticks(rotation=45)
        plt.tight_layout()
        plt.savefig(f'../可视化结果/问题3_异常值检测.png', dpi=300, bbox_inches='tight')
        plt.show()
