...
class Visualizer:
    ...
    def plot_data_overview(self):
        ...
        plt.suptitle(f'问题1 - 数据概览', fontsize=16)
        plt.tight_layout()
        plt.savefig(f'{self.output_dir}/问题1_数据概览.png', 
    ...
    def plot_results(self):
        ...
        plt.suptitle(f'问题1 - 结果可视化')
        plt.tight_layout()
        plt.savefig(f'{self.output_dir}/问题1_结果可视化.png', 
                   dpi=300, bbox_inches='tight')
        plt.show()
    ...
    def create_interactive_plot(self):
        ...
        fig = px.scatter_matrix(
            numeric_data,
            title=f'问题1 - 交互式散点图矩阵',
            height=600
        )
        
        # 保存为HTML文件
        fig.write_html(f'{self.output_dir}/问题1_交互式图表.html')
        fig.show()
    ...
    def plot_model_performance(self, metrics):
        ...
        ax.set_title(f'问题1 - 模型性能指标')
        ax.set_ylabel('指标值')
        plt.xticks(rotation=45)
        plt.tight_layout()
        plt.savefig(f'{self.output_dir}/问题1_模型性能.png', 
                   dpi=300, bbox_inches='tight')
        plt.show()
